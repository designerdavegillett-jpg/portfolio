...
export const passportStudies: CaseStudy[] = [
  {
    ...
    sections: [
      {
        heading: "Background",
        body: "Passport Unlimited is an established savings and discount program connecting users with participating vendors. By the time this project started, the desktop experience had already been modernized — but the mobile app was a different story. It was old, outdated, and barely used.\n\nThe mobile app was the primary touchpoint for users on the go, which made its neglect a real problem. The company had the bones of a valuable product; the app just wasn't reflecting that.",
      },
      {
      ...
      {
        heading: "Outcome",
        body: "The app shipped and was adopted well. UI was iterated post-launch based on direct user feedback. The in-app feedback loop created measurable insight into offer quality — previously invisible to the business. Developer sourcing saved the company thousands in development fees.",
      },
      {
