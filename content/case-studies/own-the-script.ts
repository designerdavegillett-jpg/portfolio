...
export const ownTheScriptStudies: CaseStudy[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        figures: [
          {
            src: "/work/own-the-script/compliance-gate.png",
            alt: "The compliance review screen listing flagged phrases with severity, the rule each one triggered, and the disclosures that will be added to the export.",
            width: 1762,
            height: 990,
            caption:
      ...
      },
      {
        ...
        figures: [
          {
            src: "/work/own-the-script/teleprompter.webp",
            alt: "The capture screen with the teleprompter running over the live camera preview, the active line in orange and the next line already warming.",
            width: 1600,
            height: 899,
            caption:
              "The active word is the one after the aligner's cursor, so the marker points at what you are about to say rather than at what you have finished saying.",
          },
        ],
      },
      {
        ...
        figures: [
          ...
          {
            src: "/work/own-the-script/connected-contradiction.png",
