...
const RECORDS: Record[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Designed and built a working prototype of an AI-assisted in-person selection system — listening to the live designer-client conversation and surfacing matching items from the supplier catalog for the client to review in the moment",
